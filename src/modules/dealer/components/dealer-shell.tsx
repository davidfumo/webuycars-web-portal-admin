...
const nav = [
  { href: "/dealer/dashboard", key: "dealerDashboard", icon: LayoutDashboard },
  { href: "/dealer/listings", key: "dealerListings", icon: Car },
  { href: "/dealer/subscription", key: "dealerSubscription", icon: Package },
  { href: "/dealer/staff", key: "dealerStaff", icon: Users },
  { href: "/dealer/payments", key: "dealerPayments", icon: CreditCard },
  { href: "/dealer/reports", key: "dealerReports", icon: LineChart },
  { href: "/dealer/notifications", key: "dealerNotifications", icon: Bell },
] as const;
